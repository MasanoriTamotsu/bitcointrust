    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a BitcoinTrust address (e.g. TVqVV4t1fmqawZVkcJZaUmnkz9ZGNmk6t3)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a BitcoinTrust address (e.g. TVqVV4t1fmqawZVkcJZaUmnkz9ZGNmk6t3)"));
